...
<html>
    <head>
        ...
        <link rel="stylesheet" href="\hw1\index.css">
        <script src="\hw1\index.js" defer></script>
    ...
    <body>
        ...
        <div id="link_nav1">
            ...
            <div id="link_nav2">
                <a href="\hw1\login.php" class="a_nav login" id="login">Login</a>
                <a href="\hw1\login.php" class="a_nav login"><img src="\hw1\img\user.png" id="user"></a>
            </div>
        </nav>
        ...
        <section id="Section5">
            ...
            <div class="Section5_container">
                <div class="Section5_item-container">
